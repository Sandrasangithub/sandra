...
echo '<a class="exitbutton" href="' . $rutita . '/sandra.xml" target="_blank">Comprobar Sitemap</a>';
$dompage->save('sandra.xml') or die('XML Create Error');
...
// Así vemos el código que se hace
echo '<code class="codigo-post"><xmp>'. $domblog->saveXML() .'</xmp></code>';
echo '<a class="exitbutton" href="' . $rutita . '/sitemap-noticias.xml" target="_blank">Comprobar Sitemap</a>';
$domblog->save('sitemap-noticias.xml') or die('XML Create Error');
